			...
			<body>
              ...
              <xsl:element name="a">
                ...
                <xsl:value-of select="node()"/>
      				...
      				<p>L'evento si svolgerà a <xsl:value-of select="luogo"/> dalle <xsl:value-of select="OraInizio"/> alle <xsl:value-of select="oraFine"/> presso <xsl:value-of select="indirizzo"/> al costo di <xsl:value-of select="prezzo"/> per informazioni contattare <xsl:value-of select="email"/> oppure telefonare al <xsl:value-of select="telefono"/></p>
    			</div>
    			<div id="footer">
